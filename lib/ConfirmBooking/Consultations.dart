...
class ConsultationsTypeState extends State<ConsultationsType> {
  ...
  /// Bottom sheet for In-Clinic & Online
          ...
          child: Column(
            ...
            children: [
              ListTile(
                ...
                title: const Text("In-Clinic Consultation"),
                onTap: () {
                  Navigator.pop(context);
                  Get.to(() => SymptomsForm(
                        mobileNumber: widget.mobileNumber,
                        username: widget.username,
                        consulationType: "In-Clinic Consultation",
                      ));
                },
              ),
              const Divider(),
              ListTile(
                ...
                onTap: () {
                  ...
                  Get.to(() => SymptomsForm(
                        mobileNumber: widget.mobileNumber,
                        username: widget.username,
                        consulationType: "Online Consultation",
                      ));
                },
              ),
            ],
