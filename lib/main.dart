...
// ✅ This can be called anywhere (after booking success or on dashboard)
// Future<void> scheduleVideoCallNotification({
//   required String title,
//   required String body,
//   required DateTime videoCallTime,
...
//     });
//   } else {
//     print('[⚠️] Alert time is in the past. Speaking now...');
//     await flutterTts.speak(body);
//   }
...
//           importance: Importance.max,
//           priority: Priority.high,
//           playSound: false, // Using voice instead of sound
//         ),
//       ),
//       androidAllowWhileIdle: true,
//       uiLocalNotificationDateInterpretation:
