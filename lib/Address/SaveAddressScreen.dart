  ...
  void _saveAddressDetails() async {
    ...
    try {
      ...
      type: SnackbarType.success,
        ...
        //   // Pass the sublocality as an argument
        // );
       ...
       ScaffoldMessageSnackbar.show(
      context: context,
      message: "Failed to send address",
      type: SnackbarType.error,
        ...
        ScaffoldMessageSnackbar.show(
      context: context,
      message: "Failed to send address. Status code",
      type: SnackbarType.error,
    );
        print(
      ...
      ScaffoldMessageSnackbar.show(
    context: context,
    message: "Error during address confirmation",
    type: SnackbarType.error,
  );
                      ...
                      child: Container(
                        ...
                        child: const Row(
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                "Provide your complete address to ensure the timely arrival of our Healthcare Provider",
                                style: TextStyle(
                                  color: const Color.fromARGB(255, 0, 0, 0),
                                  fontSize: 14,
                                ),
